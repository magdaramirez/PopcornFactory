...
class catalogo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var gridSeries: GridView=findViewById(R.id.mSeriesCatalago)
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Ghostbusters Apocalipsis",
                                R.drawable.posterghostbusters,
        ...
        peliculas.add(Pelicula("Héroe Por Encargo",
        ...
        peliculas.add(Pelicula("Vidas Pasadas",
        ...
        peliculas.add(Pelicula("Madame Web",
    ...
    fun cargarSeries(){
        series.add(Pelicula("Avatar: La leyenda de Aang",R.drawable.ant,R.drawable.headeravatar,"La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego."))
    ...
    class PeliculaAdapter:BaseAdapter{
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            var image: ImageView = vista.findViewById(R.id.imgMovieCell)
